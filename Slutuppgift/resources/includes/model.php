<?php
require 'resources/includes/db_conn.php'; // att den behöver uppkoppling  till php myadmin 

if ($pdo) {

    // en  lista med alla inlägg som har gjorts, och även vilka som har gjort dom.
